    ...
    <main>
        <?php 
            foreach ($array as $key => $element) {
                echo "<h2>".$element["domanda"]."</h2>"."<br>";
                echo "<h4>".$element["risposta"]."</h4>"."<br>";
            };
        ?>
    </main>
</body>
